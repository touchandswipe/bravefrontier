...
bbMap=[
	...
	{desc:"% Paralysis", impact:"paralyse%"},
...
/*generate squad summary*/
	...
	for (var key in sElement)
		if (sElement[key]!=0)
			sElementCount+=1
	/*generate HTML*/
	sHTML+='<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 text-center"><span id="share_this_icon"></span><h5 style="margin-top:4px;">Share Squad</h5></div>';
