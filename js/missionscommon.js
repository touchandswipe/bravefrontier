...
function resetLocalData(corrupted) {
	...
	/*LocalStorage Delete and Refresh*/
    	if (serverChoice.search('/jp/')==-1)
    		var localServerSelect="missionsguideglobal";
    	else
    		var localServerSelect="missionsguidejapan";
	/*Resets*/
...
$( ".dataBtn" ).on( "click", function() {
  if ($(this).text()=="Global")
  	serverChoice="//touchandswipe.github.io/bravefrontier_data/missions.json"
  else
  	serverChoice="//touchandswipe.github.io/bravefrontier_data/jp/missions.json";
