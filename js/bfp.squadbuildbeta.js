...
lsMap=[
	...
	{desc:"% Spark DMG+ on SparkCount", impact:"!spark count buff activation||buff.spark dmg% buff", impact2:"!buff.spark dmg% buff", turns:"!buff.buff turns (72)",criteria:["spark count buff activation"], hideprefix:true},
